...
with DAG(
    ...
    run_crypto_producer = PythonOperator(
        ...
        op_args=["src/data_ingestion/kafka_producer/crypto_producer.py"]
    )
    ...
    run_ws_feeder = PythonOperator(
        ...
        python_callable=run_script,
        op_args=["src.data_ingestion.crypto_feeds.example", True]
    )
    ...
    run_price_processor = PythonOperator(
        ...
        python_callable=run_script,
        op_args=["src/processing/stream_processor/price_processor.py"]
    )
    ...
    run_anomaly_detector = PythonOperator(
        ...
        python_callable=run_script,
        op_args=["src/processing/anomaly_detector/price_anomaly_detector.py"]
    )
    ...
    run_discord_alert_bot = PythonOperator(
        ...
        python_callable=run_script,
        op_args=["src/visualization/discord_bot/alert_bot.py"]
    )
